...
function() {
    ...
    var n, o = document.querySelector(".dropdown-style-switcher"), s = localStorage.getItem("templateCustomizer-" + templateName + "--Style") || (window.templateCustomizer?.settings?.defaultStyle ?? "light"), o = (window.templateCustomizer && o && ([].slice.call(o.children[1].querySelectorAll(".dropdown-item")).forEach(function(e) {
    ...
    o = o.querySelector("i"),
    "light" === s ? (o.classList.add("mdi-weather-sunny"),
    new bootstrap.Tooltip(o,{
        title: "Light Mode",
        fallbackPlacements: ["bottom"]
    })) : "dark" === s ? (o.classList.add("mdi-weather-night"),
    new bootstrap.Tooltip(o,{
        title: "Dark Mode",
        fallbackPlacements: ["bottom"]
    ...
    if (c && (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT ? window.Helpers.setNavbarFixed("fixed") : window.Helpers.setNavbarFixed("")),
...
"undefined" != typeof $ && $(function() {
    ...
    var t, a, e, n = $(".search-toggler"), o = $(".search-input-wrapper"), s = $(".search-input"), i = $(".content-backdrop");
    n.length && n.on("click", function() {
        o.length && (o.toggleClass("d-none"),
        s.focus())
    }),
    $(document).on("keydown", function(e) {
        var t = e.ctrlKey
          , e = 191 === e.which;
        t && e && o.length && (o.toggleClass("d-none"),
        s.focus())
    }),
    setTimeout(function() {
        var e = $(".twitter-typeahead");
        s.on("focus", function() {
            o.hasClass("container-xxl") ? (o.find(e).addClass("container-xxl"),
            e.removeClass("container-fluid")) : o.hasClass("container-fluid") && (o.find(e).addClass("container-fluid"),
